...
import { WaDoughnutChartDirective } from './doughnut-chart.directive';
@Component({
  template: `
    <wa-doughnut-chart
      [label]="label"
  ...
  `,
  standalone: true,
  imports: [WaDoughnutChartDirective]
})
...
describe('WaDoughnutChartDirective', () => {
  ...
  beforeEach(async () => {
    ...
    chartElement = hostFixture.nativeElement.querySelector('wa-doughnut-chart');
  });
