...
/**
 * WaDoughnutChartDirective
 *
 * Angular wrapper for the <wa-doughnut-chart> Web Component.
 * Doughnut charts offer a cleaner look than pie charts that works well in dashboards.
 */
@Directive({
  selector: 'wa-doughnut-chart',
  standalone: true
})
export class WaDoughnutChartDirective implements OnInit, OnChanges {
