 ...
 * WaPieChartDirective
 *
 * Angular wrapper for the <wa-pie-chart> Web Component.
 * Pie charts work best with a small number of categories where relative proportions matter.
 */
@Directive({
  selector: 'wa-pie-chart',
  standalone: true
})
export class WaPieChartDirective implements OnInit, OnChanges {
