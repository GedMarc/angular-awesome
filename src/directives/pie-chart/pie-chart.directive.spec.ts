...
import { WaPieChartDirective } from './pie-chart.directive';
@Component({
  template: `
    <wa-pie-chart
      [label]="label"
...
describe('WaPieChartDirective', () => {
  ...
  beforeEach(async () => {
    ...
    chartElement = hostFixture.nativeElement.querySelector('wa-pie-chart');
  });
