...
/**
 * WaBubbleChartDirective
 *
 * Angular wrapper for the <wa-bubble-chart> Web Component.
 * Bubble charts are useful for visualizing relationships where a third variable
 * adds meaning beyond a simple x/y correlation.
 */
@Directive({
  selector: 'wa-bubble-chart',
  standalone: true
})
export class WaBubbleChartDirective implements OnInit, OnChanges {
