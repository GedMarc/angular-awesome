...
/**
 * WaScatterChartDirective
 *
 * Angular wrapper for the <wa-scatter-chart> Web Component.
 * Scatter charts are ideal for identifying correlations, clusters, and outliers.
 */
@Directive({
  selector: 'wa-scatter-chart',
  standalone: true
})
export class WaScatterChartDirective implements OnInit, OnChanges {
