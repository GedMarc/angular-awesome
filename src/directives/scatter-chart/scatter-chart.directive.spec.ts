...
import { WaScatterChartDirective } from './scatter-chart.directive';
@Component({
  template: `
    <wa-scatter-chart
      [label]="label"
  ...
  `,
  standalone: true,
  imports: [WaScatterChartDirective]
})
...
describe('WaScatterChartDirective', () => {
  ...
  beforeEach(async () => {
    ...
    chartElement = hostFixture.nativeElement.querySelector('wa-scatter-chart');
  });
