...
/**
 * WaRadarChartDirective
 *
 * Angular wrapper for the <wa-radar-chart> Web Component.
 * Radar charts compare profiles across several dimensions.
 */
@Directive({
  selector: 'wa-radar-chart',
  standalone: true
})
export class WaRadarChartDirective implements OnInit, OnChanges {
