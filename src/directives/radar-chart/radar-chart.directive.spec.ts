...
import { WaRadarChartDirective } from './radar-chart.directive';
@Component({
  template: `
    <wa-radar-chart
      [label]="label"
...
describe('WaRadarChartDirective', () => {
  ...
  beforeEach(async () => {
    ...
    chartElement = hostFixture.nativeElement.querySelector('wa-radar-chart');
  });
