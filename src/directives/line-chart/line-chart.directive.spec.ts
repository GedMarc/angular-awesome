...
import { WaLineChartDirective } from './line-chart.directive';
@Component({
  template: `
    <wa-line-chart
      [label]="label"
...
describe('WaLineChartDirective', () => {
  ...
  beforeEach(async () => {
    ...
    chartElement = hostFixture.nativeElement.querySelector('wa-line-chart');
  });
