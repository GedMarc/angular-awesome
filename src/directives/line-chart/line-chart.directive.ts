...
/**
 * WaLineChartDirective
 *
 * Angular wrapper for the <wa-line-chart> Web Component.
 * Line charts emphasize the shape and direction of data over a sequential dimension.
 */
@Directive({
  selector: 'wa-line-chart',
  standalone: true
})
export class WaLineChartDirective implements OnInit, OnChanges {
