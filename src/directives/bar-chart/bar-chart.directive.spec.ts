...
import { WaBarChartDirective } from './bar-chart.directive';
@Component({
  template: `
    <wa-bar-chart
      [label]="label"
...
describe('WaBarChartDirective', () => {
  ...
  beforeEach(async () => {
    ...
    chartElement = hostFixture.nativeElement.querySelector('wa-bar-chart');
  });
