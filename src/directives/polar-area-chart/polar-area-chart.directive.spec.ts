...
import { WaPolarAreaChartDirective } from './polar-area-chart.directive';
@Component({
  template: `
    <wa-polar-area-chart
      [label]="label"
  ...
  `,
  standalone: true,
  imports: [WaPolarAreaChartDirective]
})
...
describe('WaPolarAreaChartDirective', () => {
  ...
  beforeEach(async () => {
    ...
    chartElement = hostFixture.nativeElement.querySelector('wa-polar-area-chart');
  });
