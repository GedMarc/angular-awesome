...
/**
 * WaPolarAreaChartDirective
 *
 * Angular wrapper for the <wa-polar-area-chart> Web Component.
 * Polar area charts compare magnitudes without visual bias using equal angles and varying radius.
 */
@Directive({
  selector: 'wa-polar-area-chart',
  standalone: true
})
export class WaPolarAreaChartDirective implements OnInit, OnChanges {
